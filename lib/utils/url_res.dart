...
class UrlRes {
  ...
  static const String fetchPropertyReceiveTourList =
      '${ConstRes.baseUrl}fetchPropertyReceiveTourList';
  static const String fetchPropertyTourSubmittedList =
      '${ConstRes.baseUrl}fetchPropertyTourSubmittedList';
  ...
  static String getPlaceDetail({required String placeID, required String apiKey}) =>
  ...
  static const String fetchReelsByUser = '${ConstRes.baseUrl}fetchReelsByUser';
  static const String deleteReel = '${ConstRes.baseUrl}deleteReel';
  static const String fetchReelsByHashtag = '${ConstRes.baseUrl}fetchReelsByHashtag';
  static const String fetchReelsOnHomePage = '${ConstRes.baseUrl}fetchReelsOnHomePage';
